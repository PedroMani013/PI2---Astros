    ...
    <div id="tudo">
        ...
        <main>
            <div class="greenpopup">
                ...
                <h2>SUA ATA ESTÁ SENDO BAIXADA</h2>
                <h3>Caso o download falhe, verifique sua caixa de entrada</h3>
                <p><a href="votosapurados.php">Clique Aqui para voltar para a votação</a></p>
                <span>.</span>
            </div> 
        </main>
        <footer class="rodape">
