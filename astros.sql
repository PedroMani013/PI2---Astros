...
VALUES
-- 10 Gestão Empresarial (idvotacao = 3)
('Lucas Ferreira', 2780642613001, 'lucas.ferreira@fatec.sp.gov.br', 'Lf8921aa', 'Gestão Empresarial', 1, 3),
('Mariana Duarte', 2780642613002, 'mariana.duarte@fatec.sp.gov.br', 'Md4472bb', 'Gestão Empresarial', 1, 3),
('Ricardo Alves', 2780642613003, 'ricardo.alves@fatec.sp.gov.br', 'Ra7315cc', 'Gestão Empresarial', 1, 3),
('Juliana Campos', 2780642613004, 'juliana.campos@fatec.sp.gov.br', 'Jc1289dd', 'Gestão Empresarial', 1, 3),
('Gabriel Manrique', 2780642613005, 'gabriel.manrique@fatec.sp.gov.br', '12345678', 'Gestão Empresarial', 1, 3),
('Ana Ribeiro', 2780642613006, 'ana.ribeiro@fatec.sp.gov.br', 'Ar8744ff', 'Gestão Empresarial', 1, 3),
('Thiago Moreira', 2780642613007, 'thiago.moreira@fatec.sp.gov.br', 'Tm2248gg', 'Gestão Empresarial', 1, 3),
('Patricia Gomes', 2780642613008, 'patricia.gomes@fatec.sp.gov.br', 'Pg6012hh', 'Gestão Empresarial', 1, 3),
('Felipe Cardoso', 2780642613009, 'felipe.cardoso@fatec.sp.gov.br', 'Fc9150ii', 'Gestão Empresarial', 1, 3),
('Beatriz Moura', 2780642613010, 'beatriz.moura@fatec.sp.gov.br', 'Bm3782jj', 'Gestão Empresarial', 1, 3),
...
-- 10 Gestão de Produção Industrial (idvotacao = 1)
('João Figueiredo', 2781622613001 , 'joao.figueiredo@fatec.sp.gov.br', 'Jf5001uu', 'Gestão de Produção Industrial', 1, 1),
('Larissa Barros', 2781622613002 , 'larissa.barros@fatec.sp.gov.br', 'Lb3390vv', 'Gestão de Produção Industrial', 1, 1),
('Matheus Prado', 2781622613003 , 'matheus.prado@fatec.sp.gov.br', 'Mp4682ww', 'Gestão de Produção Industrial', 1, 1),
('Pedro Fernandes', 2781622613004 , 'pedro.fernandes@fatec.sp.gov.br', '12345678', 'Gestão de Produção Industrial', 1, 1),
('André Pires', 2781622613005 , 'andre.pires@fatec.sp.gov.br', 'Ap1109yy', 'Gestão de Produção Industrial', 1, 1),
('Helena Batista', 2781622613006 , 'helena.batista@fatec.sp.gov.br', 'Hb4470zz', 'Gestão de Produção Industrial', 1, 1),
('Rogério Simões', 2781622613007 , 'rogerio.simoes@fatec.sp.gov.br', 'Rs9031aa', 'Gestão de Produção Industrial', 1, 1),
('Sabrina Lopes', 2781622613008 , 'sabrina.lopes@fatec.sp.gov.br', 'Sl2608bb', 'Gestão de Produção Industrial', 1, 1),
('Diego Barcellos', 2781622613009 , 'diego.barcellos@fatec.sp.gov.br', 'Db7764cc', 'Gestão de Produção Industrial', 1, 1),
('Tatiane Moraes', 2781622613010 , 'tatiane.moraes@fatec.sp.gov.br', 'Tm8420dd', 'Gestão de Produção Industrial', 1, 1);